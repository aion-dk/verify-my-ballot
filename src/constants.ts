...
export const MOCK_RESPONSE_MS = 4000
...
export const TIMEOUT_REMINDER_TIME = _timeoutReminderTime
  ...
  ? MOCK_RESPONSE_MS / 1000 / 0.5 // half of mock response time, so you can see the popup
  : 15

export const STRICT_MODE = process.env.REACT_APP_STRICT || false // default false
